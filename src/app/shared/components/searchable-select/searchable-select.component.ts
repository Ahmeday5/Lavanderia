 ...
 * grows past the point of comfortable scrolling.
 *
 ...
 *   />
 *
 * Also works with `[ngModel]/(ngModelChange)` for signal-driven pages.
 * Filtering is in-memory over the already-loaded `options`, so typing never
 * hits the network and there is no debounce/race to reason about.
 *
...
export class SearchableSelectComponent implements ControlValueAccessor {
   ...
   * caller can offer inline creation instead of forcing a dead-end search.
   */
